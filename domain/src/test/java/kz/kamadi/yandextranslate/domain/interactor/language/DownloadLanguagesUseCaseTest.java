...
public class DownloadLanguagesUseCaseTest {
    @Mock
    ...
    @Test
    public void testDownloadLanguages() {

        DownloadLanguagesUseCase useCase = new DownloadLanguagesUseCase(mockThreadExecutor, mockPostExecutionThread, repository);

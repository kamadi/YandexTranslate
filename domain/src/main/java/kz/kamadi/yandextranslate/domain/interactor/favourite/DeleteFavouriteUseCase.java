...
public class DeleteFavouriteUseCase extends UseCase<Boolean> {

    private FavouriteRepository repository;
    private HistoryEntity entity;

    @Inject
    public DeleteFavouriteUseCase(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, FavouriteRepository repository) {
